...
def resnet18_REDL(pretrained=False, num_classes=None, **kwargs):
...
def resnet34_REDL(pretrained=False, num_classes=None, **kwargs):
...
def resnet50_REDL(pretrained=False, num_classes=None, **kwargs):

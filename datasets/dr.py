...
#########训练和测试集转换为8：2##########
        ...
        for i in data_num:
            if self.balanced:
                f = open('/data3/tongshuo/dataset/image/DR_dataset/ten_fold_balanced/fold_{}.csv'.format(i), "r")
            else:
                f = open('/data3/tongshuo/dataset/image/DR_dataset/ten_fold/fold_{}.csv'.format(i), "r")
